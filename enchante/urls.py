...
from pastry_app.views import RecipeViewSet, IngredientViewSet, IngredientDeleteView, RecipeDeleteView, PanViewSet, PanDeleteView, CategoryViewSet, LabelViewSet
