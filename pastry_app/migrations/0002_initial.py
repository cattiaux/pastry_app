# Generated by Django 4.2.6 on 2025-08-20 17:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='created_categories', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['sub_recipe'], name='idx_subrecipe_on_sub'), models.Index(fields=['recipe'], name='idx_subrecipe_on_host')],
            },
        ),
        migrations.AddIndex(
            model_name='store',
