...
REFERENCES = [
    ...
    {"ingredient_name": "levure boulangère sèche", "unit": "cc", "weight_in_grams": 3, "notes": "1 cc = 3g"},
    {"ingredient_name": "levure boulangère sèche", "unit": "sachet", "weight_in_grams": 5, "notes": "Sachet standard"},
    {"ingredient_name": "bicarbonate de soude", "unit": "cc", "weight_in_grams": 5, "notes": "1 cc = 5g"},
    ...
    {"ingredient_name": "crème épaisse", "unit": "cs", "weight_in_grams": 20, "notes": "1 cuillère à soupe = 20g"},

    # Farine
    {"ingredient_name": "farine", "unit": "cs", "weight_in_grams": 10, "notes": "1 cuillère à soupe rase = 10g"},
    {"ingredient_name": "farine", "unit": "cc", "weight_in_grams": 3, "notes": "1 cuillère à café rase = 3g"},
    {"ingredient_name": "farine", "unit": "cup", "weight_in_grams": 120, "notes": "1 cup = 120g"},
    {"ingredient_name": "maïzena", "unit": "cs", "weight_in_grams": 8, "notes": "1 cuillère à soupe rase = 8g"},

    # Sucre & dérivés
    {"ingredient_name": "sucre", "unit": "cs", "weight_in_grams": 15, "notes": "1 cuillère à soupe = 15g"},
    {"ingredient_name": "sucre", "unit": "cc", "weight_in_grams": 5, "notes": "1 cuillère à café = 5g"},
    {"ingredient_name": "sucre", "unit": "cup", "weight_in_grams": 200, "notes": "1 cup = 200g"},
    {"ingredient_name": "sucre glace", "unit": "cs", "weight_in_grams": 12, "notes": "1 cuillère à soupe = 12g"},
    {"ingredient_name": "cassonade", "unit": "cs", "weight_in_grams": 14, "notes": "1 cuillère à soupe = 14g"},

    # Beurre, Margarine & Huiles
    {"ingredient_name": "beurre", "unit": "cs", "weight_in_grams": 12, "notes": "1 cuillère à soupe = 12g"},
    ...
    {"ingredient_name": "huile", "unit": "cs", "weight_in_grams": 10, "notes": "1 cuillère à soupe = 10g"},
    {"ingredient_name": "huile", "unit": "cc", "weight_in_grams": 3, "notes": "1 cuillère à café = 3g"},

    # Sel & épices
    {"ingredient_name": "sel", "unit": "cc", "weight_in_grams": 5, "notes": "1 cuillère à café = 5g"},
    {"ingredient_name": "fleur de sel", "unit": "cc", "weight_in_grams": 3, "notes": "1 cuillère à café = 3g"},
    {"ingredient_name": "cannelle", "unit": "cc", "weight_in_grams": 2, "notes": "1 cuillère à café = 2g"},
    {"ingredient_name": "cacao en poudre", "unit": "cs", "weight_in_grams": 8, "notes": "1 cuillère à soupe = 8g"},

    # Chocolat & fruits secs
    {"ingredient_name": "chocolat", "unit": "carré", "weight_in_grams": 5, "notes": "1 carré = 5g"},
    {"ingredient_name": "amande en poudre", "unit": "cs", "weight_in_grams": 10, "notes": "1 cuillère à soupe = 10g"},
    {"ingredient_name": "noisettes", "unit": "cs", "weight_in_grams": 10, "notes": "1 cuillère à soupe = 10g"},
    {"ingredient_name": "pistaches", "unit": "cs", "weight_in_grams": 10, "notes": "1 cuillère à soupe = 10g"},
    {"ingredient_name": "pépites de chocolat", "unit": "cs", "weight_in_grams": 15, "notes": "1 cuillère à soupe = 15g"},
    ...
    {"ingredient_name": "fromage blanc", "unit": "cs", "weight_in_grams": 20, "notes": "1 cuillère à soupe = 20g"},
    {"ingredient_name": "compote", "unit": "cs", "weight_in_grams": 20, "notes": "1 cuillère à soupe = 20g"},
    {"ingredient_name": "miel", "unit": "cs", "weight_in_grams": 25, "notes": "1 cuillère à soupe = 25g"},
    {"ingredient_name": "confiture", "unit": "cs", "weight_in_grams": 20, "notes": "1 cuillère à soupe = 20g"},
    {"ingredient_name": "pâte à tartiner", "unit": "cs", "weight_in_grams": 20, "notes": "1 cuillère à soupe = 20g"},
]
